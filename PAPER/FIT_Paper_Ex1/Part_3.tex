...
% #########################################################################################
% #########################################################################################
\section{Exercise design \label{sec:ex_design}}

% -----------------------------------------------------------------------------------------
\subsection{Description of the tested functionality\label{subsec:func_desc}}
...
\subsection{Output of interest\label{subsec:OutOfI}}
...
% -----------------------------------------------------------------------------------------
\subsection{Exercise specifications\label{subsec:ex_spec}
...
\subsubsection{Estimator 1\label{subsubsec:est1}}
...
\subsubsection{Estimator 2\label{subsubsec:est2}}
...
\subsubsection{Estimator 3\label{subsubsec:est3}}
...
% -----------------------------------------------------------------------------------------
\subsection{Output observables\label{subsec:est1}}
