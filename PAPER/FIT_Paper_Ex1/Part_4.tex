...
composition using a FF for plutonium enrichment is then estimated with a bias
...
ratio when simulation are made with a FF or with a FLM. CLASS and TR\_EVOL shows
similar results and calculate biases induced by the FF method up to 0.1. JOSETTE
